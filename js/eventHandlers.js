// js/eventHandlers.js - Fixed version with syntax error corrected
...
export function initEventListeners() {
    document.body.addEventListener('click', e => {
        ...
        const actions = {
            ...
            stopRestTimer,
            submitCheckin,
            connectGoogleAccount: connectToGoogleSheets,
            addSet: () => {
                triggerHapticFeedback('light');
    ...
    // Direct event listener for the Connect to Google button
